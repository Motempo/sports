import type { PremierLeagueRaceInsight } from "@/lib/premier-league-types";
...
function RaceCard({ insight }: { insight: PremierLeagueRaceInsight }) {
  const accent =
    insight.kind === "title"
      ? "border-[#00FF85]/35 bg-[#00FF85]/5"
